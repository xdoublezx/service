...
class WorkersController extends Controller
{
    ...
    public function actionIndoCreate()
     {
    $model=Workers::find()->asArray()->all();
    return $this->render('viewall',['model'=>$model]);
        
    }
    public function actionReturnname($worker_id){
    $model=Workers::findOne(['worker_id'=>$worker_id]);
    return $model['worker_name'];
    }
